...
function cateSlide() {
    ...
    $categorySlider.find('.thumbList').each(function(i){
        ...
        $(this).find('.swiper-wrapper').addClass("type"+i);
        // $(this).find(".custom-fraction .allPage").addClass("type"+i);
        ...
        var thumbSwiper  = new Swiper($(this), {
            ...
            on: {
                init: function() {
                    ...
                    var a = $(this).find(".swiper-wrapper.type"+ i + ' .swiper-slide').length;
                    console.log(a);
                    // $('.custom-fraction .allPage').text(a);
                    
                    // $categorySlider.find('.allPage.type'+i).text(this.loopedSlides);
                },
                slideChangeTransitionStart: function() {
